...
namespace Capisso.Migrations
{
    ...
    [Migration("20200928220145_AddUniqueConstraintOnUserTable")]
    partial class AddUniqueConstraintOnUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Capisso.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Capisso.Entities.Project", b =>
                {
                    b.HasOne("Capisso.Entities.Contact", "Contact")
                        .WithMany("Projects")
